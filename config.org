...
Set up formatting. Julia code cannot currently be formatted by Doom and
~format-all~, so use ~julia-formatter~ instead.
#+begin_src emacs-lisp :tangle yes
(use-package! julia-formatter
  :when (featurep! :lang julia)
...
#+begin_src emacs-lisp
(custom-set-faces!
  '(outline-1 :family "Iosevka Aile")
  '(outline-2 :family "Iosevka Aile")
  '(outline-3 :family "Iosevka Aile")
  '(outline-4 :family "Iosevka Aile")
  '(outline-5 :family "Iosevka Aile")
  '(outline-6 :family "Iosevka Aile")
  '(outline-8 :family "Iosevka Aile")
  '(outline-9 :family "Iosevka Aile"))
#+end_src
